...
* 使用合适、清晰、合适阅读的字号、字体和颜色；粗体、斜体和下划线用于强调和醒目，全部都用的效果是屏幕上都是色块而完全无法阅读。然后，把你那张难看的邮件背景图删掉。
...
这篇文章可能随着时间会慢慢过期、甚至可能不再适用于那时的互联网业界。而且我现在寥寥数年的互联网从业经历还远远不够，如有不足之处欢迎提出改善意见。
